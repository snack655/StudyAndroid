...
public class CustomViewDrawable extends View {
    ...
    private void init(Context context) {
        ...
        int blackColor = curRes.getColor(R.color.black);
        int grayColor = curRes.getColor(R.color.cardview_shadow_end_color);
        int darkGrayColor = curRes.getColor(R.color.cardview_shadow_start_color);
